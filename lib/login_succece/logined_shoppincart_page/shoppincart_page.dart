...
import 'package:aladdin_project/login_succece/logined_shoppincart_page/page/locker_page.dart';
...
class LoginedShoppinCartPage extends StatefulWidget {
  const LoginedShoppinCartPage({Key? key}) : super(key: key);

  @override
  State<LoginedShoppinCartPage> createState() => _LoginedShoppinCartPageState();
}

class _LoginedShoppinCartPageState extends State<LoginedShoppinCartPage>
